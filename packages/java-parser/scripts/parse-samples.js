...
samplesDir.push(path.resolve(__dirname, "../samples/jhipster-sample-app-cassandra"));
samplesDir.push(path.resolve(__dirname, "../samples/jhipster-sample-app-couchbase"));
samplesDir.push(path.resolve(__dirname, "../samples/jhipster-sample-app-dto"));
samplesDir.push(path.resolve(__dirname, "../samples/jhipster-sample-app-elasticsearch"));
samplesDir.push(path.resolve(__dirname, "../samples/jhipster-sample-app-gateway"));
samplesDir.push(path.resolve(__dirname, "../samples/jhipster-sample-app-gradle"));
samplesDir.push(path.resolve(__dirname, "../samples/jhipster-sample-app-hazelcast"));
samplesDir.push(path.resolve(__dirname, "../samples/jhipster-sample-app-microservice"));
samplesDir.push(path.resolve(__dirname, "../samples/jhipster-sample-app-mongodb"));
samplesDir.push(path.resolve(__dirname, "../samples/jhipster-sample-app-nocache"));
samplesDir.push(path.resolve(__dirname, "../samples/jhipster-sample-app-noi18n"));
samplesDir.push(path.resolve(__dirname, "../samples/jhipster-sample-app-oauth2"));
samplesDir.push(path.resolve(__dirname, "../samples/jhipster-sample-app-react"));
samplesDir.push(path.resolve(__dirname, "../samples/jhipster-sample-app-websocket"));
