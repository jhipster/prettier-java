    ...
    void shouldFormatPatternsWithGuards() {
        switch (o) {
            ...
            case Integer myVeryVeryVeryVeryExtremelyLongNameThatWillBreak
                when myVeryVeryVeryVeryExtremelyLongNameThatWillBreak > 0     -> System.out.println(">0");
            case Integer myVeryVeryVeryVeryExtremelyLongNameThatWillBreak
                when myVeryVeryVeryVeryExtremelyLongNameThatWillBreak > 2     -> System.out.println(">0");
            case Integer myVeryVeryVeryVeryExtremelyLongNameThatWillBreak
                when myVeryVeryVeryVeryExtremelyLongNameThatWillBreak > myVeryVeryVeryVeryExtremelyLongNameThatWillBreak + 2     ->{
                System.out.println(">0");
            }
            case Integer myVeryVeryVeryVeryExtremelyLongNameThatWillBreak
                when myVeryVeryVeryVeryExtremelyLongNameThatWillBreak > myVeryVeryVeryVeryExtremelyLongNameThatWillBreak + 2     -> System.out.println(">0");
            case Integer myVeryVeryVeryVeryExtremelyLongNameThatWillBreak
                when myVeryVeryVeryVeryExtremelyLongNameThatWillBreak > myVeryVeryVeryVeryExtremelyLongNameThatWillBreak + 2     ->{
                System.out.println(">0");
            }
